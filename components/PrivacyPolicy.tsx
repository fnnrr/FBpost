...
const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    if (dateElement) {
      dateElement.innerText = new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' });
    }
  ...
  return (
    ...
    >
      ...
      <p className="mb-4 text-sm text-gray-600 text-center">Last updated: <span id="lastUpdatedDate"></span></p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-3 text-blue-600">7. Your Rights</h2>
        <p className="mb-3">
          If you have interacted with our Bot via Facebook Messenger, you have the right to:
        </p>
        <ul className="list-disc list-inside ml-4 mb-3">
          <li className="mb-1"><strong>Access Your Data:</strong> Request a copy of the data we hold about you.</li>
          <li className="mb-1"><strong>Correct Your Data:</strong> Request that we correct any inaccurate information.</li>
          <li className="mb-1"><strong>Delete Your Data:</strong> Request the deletion of your data.</li>
        </ul>
        <p className="mb-3">
          To exercise these rights, please contact the Facebook Page associated with this Bot directly via Messenger.
        </p>
      </section>
